        ...
        <div className={design.cardcontainer}>
            <div className={design.cards}>
                ...
                <div className={design.carddata}>
                    ...
                    <p className={design.cardpara}>In today’s dynamic world, developing a rapid application with a smooth user interface that can adapt to specific features.</p>
                </div>
            </div>
            <div className={design.cards}>
                ...
                <div className={design.carddata}>
                    ...
                    <p className={design.cardpara}>Ever since 2019, after a solid hit from the falling rate of economic growth, the job market seems to be challenging.</p>
                </div>
            </div>
            <div className={design.cards}>
            ...
            <div className={design.cards}>
                ...
                <div className={design.carddata}>
                    ...
                    <p className={design.cardpara}>A business must always introspect the areas where they lack in order to bring about a positive change in the work environment.</p>
                </div>
            </div>
            <div className={design.cards}>
            ...
            <div className={design.cards}>
                ...
                <div className={design.carddata}>
                    ...
                    <p className={design.cardpara}>We have had an insight into Artificial Intelligence. Well, one of its subfields is machine learning and this introduction</p>
                </div>
            </div>
            <div className={design.cards}>
                ...
                <div className={design.carddata}>
                    ...
                    <p className={design.cardpara}>The two biggest social platforms have created a buzz in the application development industry.</p>
                </div>
            </div>
            <div className={design.cards}>
                ...
                <div className={design.carddata}>
                    ...
                    <p className={design.cardpara}>Python has been the most dominant programming language in the development community for quite a few years now.</p>
                </div>
            </div>
        </div>
     );
